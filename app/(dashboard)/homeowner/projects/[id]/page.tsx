import { getProject, listProjectShares } from "@/lib/actions/projects";
  ...
  return (
    ...
    >
      ...
      <TabsContent value="documents">
        <DocumentsTab project={project} role="homeowner" />
      </TabsContent>
      <TabsContent value="share">
        <ProjectSharing projectId={id} shares={shares} />
      </TabsContent>
    </ProjectDetailShell>
  );
}
