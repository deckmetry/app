...
export default async function HomeownerEstimateDetailPage({
  params,
}: {
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        description={`${estimate.deck_width_ft}' × ${estimate.deck_projection_ft}' ${estimate.deck_type} deck — ${estimate.total_area_sf ?? "—"} sf`}
      >
