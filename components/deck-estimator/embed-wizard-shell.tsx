...
import { EmbedProvider, type EmbedContextValue } from "@/lib/contexts/embed-context";
...
interface EmbedWizardShellProps {
...
export function EmbedWizardShell({
  supplierOrgId,
  supplierSlug,
  supplierName,
  logoUrl,
  ...
  // Set source on mount
  useEffect(() => {
    setSource(`ref_${supplierSlug}`);
  }, [supplierSlug, setSource]);

  const embedValue: EmbedContextValue = {
    isEmbed: true,
    supplierOrgId,
    supplierSlug,
    supplierName,
      ...
      >
        ...
        <div className="mx-auto max-w-[1600px] px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:gap-8">
            ...
            <aside className="lg:sticky lg:top-20 lg:w-[30%] lg:min-w-[360px] lg:max-w-[480px] lg:self-start">
                  ...
                  {currentStep === "job-info" ? (
                    ...
                    <>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="border rounded-lg p-4" style={{ borderColor: `${primaryColor}33`, backgroundColor: `${primaryColor}0d` }}>
